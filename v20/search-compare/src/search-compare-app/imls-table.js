define(["../../node_modules/@polymer/polymer/polymer-element.js", "./csv.js"], function (_polymerElement, _csv) {
  ...
  function _templateObject_8caae53049f411eb9278531e96673716() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n      </style>\n      <slot></slot>\n    "]);

    _templateObject_8caae53049f411eb9278531e96673716 = function _templateObject_8caae53049f411eb9278531e96673716() {
      return data;
    };
    ...
    babelHelpers.createClass(ImlsTable, [{
      ...
      value: function render() {
        ...
        this.comparisonGrid.on('datatable.init', function (_) {
          ...
          _this2.comparisonGrid.sortColumn(_this2.sortCol, _this2.sortOrd);
        ...
        this.comparisonGrid.on('datatable.sort', function (column, direction) {
          var callHasRendered = 1;

          if (_this2.sortCol !== column) {
            console.log('in col'); //console.log(column);
            //console.log(this.sortCol);

            _this2.sortCol = column + 1; //console.log(this.sortCol);

            var callHasRendered = 0;
          }

          if (_this2.sortOrd !== direction) {
            //console.log('in ord');
            //console.log(this.sortOrd);
            //console.log(direction);
            //console.log(this.sortOrd);
            _this2.sortOrd = direction === 'ascending' ? 'desc' : 'asc'; //this.sortOrd = direction;
      ...
      */
      ...
      key: "onReturnToSearchClick",
      value: function onReturnToSearchClick() {
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_8caae53049f411eb9278531e96673716());
      }
    }, {
      key: "properties",
      get: function get() {
