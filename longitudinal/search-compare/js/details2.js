...
var outletsIndex = client.initIndex('imls_v08_outlets'); // comparison data grid labels and field names  

var comparisonData = {};
comparisonData = [{
  name: 'demographic',
  display_name: 'Demographic',
  headings: ['Name', 'Population of Legal Service Area (LSA)', 'Total unduplicated population of LSA', 'Number of central libraries', 'Number of branch libraries', 'Number of bookmobiles'],
  field_names: ['service_area_population', 'unduplicated_population', 'central_libraries', 'branch_libraries', 'bookmobiles']
}, {
  name: 'staff',
...
var clusters = [{
  ...
  fields: [{
    ...
    field: "total_circulation",
    name: "Circulation"
  }, {
    field: "loans_to",
    name: "Interlibrary Loans To"
  }, {
...
index.search({
  ...
  if (err) {
    ...
    for (var h in content.hits) {
      ...
      collection.setAttribute("data-cluster", res.cluster_collection); // Event handler for similar libraries buttons
