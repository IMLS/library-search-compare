define(["../../node_modules/@polymer/polymer/polymer-element.js", "./csv.js"], function (_polymerElement, _csv) {
  ...
  function _templateObject_9d61b660b07c11e89593092ec8c12b51() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n      </style>\n      <slot></slot>\n    "]);

    _templateObject_9d61b660b07c11e89593092ec8c12b51 = function _templateObject_9d61b660b07c11e89593092ec8c12b51() {
      return data;
    };
    ...
    babelHelpers.createClass(ImlsTable, [{
        ...
        this.addEventListener('click', function (event) {
          if (event.target.classList.contains('user-compare-btn')) {
            if (_this.userCompareList.indexOf(event.target.getAttribute('data-fscs')) !== -1) {
              _this.userCompareList = _this.userCompareList.filter(function (item) {
                return item !== event.target.getAttribute('data-fscs');
              });
            } else {
              _this.userCompareList = babelHelpers.toConsumableArray(_this.userCompareList).concat([event.target.getAttribute('data-fscs')]);
            }
          }
        });
        this.render();
      ...
      value: function render() {
        ...
        this.querySelector('#user-comparison-select').addEventListener('change', function (event) {
          return _this2.compareOn = event.target.value;
        });
        var tableRows = [];
        var tableData = {};
        ...
        var _loop = function _loop() {
          ...
          if (_this2.showUserCompareListButtons) {
            tableRow = ['<i class="user-compare-btn" data-fscs="' + res["fscs_id"] + '" data-action="remove"></i>', '<a data-name="' + res['library_name'] + '" href="details.html?fscs_id=' + res["fscs_id"] + '">' + res["library_name"] + ' (' + res["fscs_id"] + ')' + '</a>'];
          } else {
      ...
      value: function gridHasRendered() {
        ...
        this.querySelectorAll('.user-compare-btn').forEach(function (el) {
          if (_this3.userCompareList.indexOf(el.getAttribute('data-fscs')) !== -1) {
      ...
      key: "userCompareListChange",
      value: function userCompareListChange() {
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_9d61b660b07c11e89593092ec8c12b51());
      }
    }, {
      key: "properties",
      get: function get() {
