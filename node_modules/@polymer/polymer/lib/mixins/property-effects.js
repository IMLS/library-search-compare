define(["exports", "../utils/boot.js", "../utils/mixin.js", "../utils/path.js", "../utils/case-map.js", "./property-accessors.js", "./template-stamp.js", "../utils/settings.js"], function (_exports, _boot, _mixin, _path, caseMap, _propertyAccessors, _templateStamp, _settings) {
  "use strict";
  ...
  var PropertyEffects = (0, _mixin.dedupingMixin)(function (superClass) {
    ...
    function (_propertyEffectsBase) {
      ...
      function PropertyEffects() {
        ...
        _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(PropertyEffects).call(this));
        /** @type {boolean} */
