define(["exports", "../utils/boot.js", "../utils/settings.js", "../utils/mixin.js", "../utils/style-gather.js", "../utils/resolve-url.js", "../elements/dom-module.js", "./property-effects.js", "./properties-mixin.js"], function (_exports, _boot, _settings, _mixin, _styleGather, _resolveUrl, _domModule, _propertyEffects, _propertiesMixin) {
  "use strict";
  ...
  var ElementMixin = (0, _mixin.dedupingMixin)(function (base) {
    ...
    function (_polymerElementBase) {
      ...
      function PolymerElement() {
        ...
        _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(PolymerElement).call(this));
